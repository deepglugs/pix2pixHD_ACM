...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--vocab_size', type=int, default=512, help='size of vocabulary for conditional network')
        ...
        self.parser.add_argument('--n_self_attention', type=int, default=0, help='number of self attention layers')
        ...
        self.parser.add_argument('--cond', action='store_true', help='use conditional labels with real images')
        self.parser.add_argument('--tokenizer', default='gpt2', help="tokenizer model to use. Only used with --cond")
